...
export const DMsStage = ({ onNext }: DMsStageProps) => {
  ...
  const chatMessages: ChatMessage[] = [
    ...
    { sender: "favour", text: "Lmaoo 😅 don’t expose me just yet", delay: 7000 },
    { sender: "favour", text: "but fr… I just met you today, but our souls have been intertwined since ages ❤️", delay: 9000 },
    { sender: "tomi", text: "😂😂 this guy… you’re smooth sha", delay: 11000 },
    { sender: "favour", text: "Nahh… just honest 😉 Baby girl 💕", delay: 13000 },
    { sender: "tomi", text: "Hmm 👀 Baby girl ke? You dey start wahala already 😏", delay: 15000 },
    { sender: "favour", text: "If wahala means falling for you, then yes 😌", delay: 17000 },
  ];
